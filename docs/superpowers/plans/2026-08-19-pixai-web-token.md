...
- [x] **Step 3: Make the smallest wording change**
...
- [x] **Step 4: Run the focused test and full test suite**
...
- [x] **Step 3: Implement minimal GraphQL transport**
...
- [x] **Step 1: Write failing adapter and registry tests**
...
- [x] **Step 3: Implement settings and adapter**
...
- [x] **Step 1: Inspect the final diff and status**
...
- [x] **Step 2: Perform independent review**
